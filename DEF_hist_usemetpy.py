...
for model in models:
    print(f'{model} begin')
    file_path1 = f'/home/share-from-2/dongyl/cmip_day/interpolated_remapbiled_289x145/N_hemisphere/ua_historical_{model}_day_interpolated_289x145_N.nc'
    file_path2 = f'/home/share-from-2/dongyl/cmip_day/interpolated_remapbiled_289x145/N_hemisphere/va_historical_{model}_day_interpolated_289x145_N.nc'
    ...
    # 对每个数据块进行并行计算
    #du_dx, du_dy = u_xr.map_blocks(compute_gradient_u)
    #dv_dx, dv_dy = v_xr.map_blocks(compute_gradient_v)
    ...
    # 将结果保存到 .npy 文件
    np.save(f'/home/dongyl/Work2024/Tl/obs_npy/DEF_historical_{model}_2060-2090_N_new.npy', DEF)
