...
#########################以下：计算meri 图数据#############################
ERA5 = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/ERA5/ua/ERA5_u_1958-2020_288x145_19levels_zonmean.nc').u[:,::-1,:,0]
JRA55 = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/JRA-55/ua/JRA55_u_1958-2022_288x145_19levels_zonmean.nc').UGRD_GDS0_ISBL_S123[:63,::-1,:,0]
#MERRA2 = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/MERRA-2/ua/u_MERRA2_1980-2022_zonmean_288x145_19levels_yearmean.nc').U[:-2]
...
obs_data = [ERA5,JRA55]
trend = [era5_trend,jra55_trend]
p_values = [era5_p_values,jra55_p_values]
...
h_ssp585 = xr.open_dataset(r'/home/dongyl/Databank/h+ssp585/zonmean/ua_h+ssp585_all_models_1958-2022_zonmean.nc').ua[:,:63,:,:,0]
...
hist_GHG = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/hist-GHG/ua_hist-GHG_all_models_1958-2019_288x145_zonmean.nc').ua[:,:,:,:,0]
hist_aer = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/hist-aer/ua_hist-aer_all_models_1958-2019_288x145_zonmean.nc').ua[:,:,:,:,0]
...
meri_trend = [obs_mean_trend, h_ssp585_slope_mme, GHG_trend_mme, aer_trend_mme]
meri_significant_points = [significant_points, significant_points_h_ssp585, significant_points_GHG, significant_points_aer]
meri_clim = [obs_mean_clim, h_ssp585_clim, GHG_clim, aer_clim]
#########################以上：计算meri 图数据#############################
###########################以下：计算bar 图数据###############################
#############bar所用数据##################
DJF_mme_trend_100minus200=np.zeros((5,2))
JJA_mme_trend_100minus200=np.zeros((5,2))
annual_mme_trend_100minus200=np.zeros((5,2))
DJF_mme_p_values_100minus200=np.zeros((5,2))
JJA_mme_p_values_100minus200=np.zeros((5,2))
annual_mme_p_values_100minus200=np.zeros((5,2))
DJF_trend_100minus200=np.zeros((3,2))
JJA_trend_100minus200=np.zeros((3,2))
annual_trend_100minus200=np.zeros((3,2))
DJF_trend_100minus200_std=np.empty((5,2))
JJA_trend_100minus200_std=np.empty((5,2))
annual_trend_100minus200_std=np.empty((5,2))
upperlevel=11
lowerlevel=9
#1. 观测bar及其std
ERA5_DJF = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/ERA5/ua/ERA5_u_1958-2020_288x145_19levels_zonmeanDJF.nc').u[:,::-1,:,:]
JRA55_DJF = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/JRA-55/ua/JRA55_u_1958-2022_288x145_19levels_zonmeanDJF.nc').UGRD_GDS0_ISBL_S123[:63,::-1,:,:]
ERA5_JJA = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/ERA5/ua/ERA5_u_1958-2020_288x145_19levels_zonmeanJJA.nc').u[:,::-1,:,:]
JRA55_JJA = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/JRA-55/ua/JRA55_u_1958-2022_288x145_19levels_zonmeanJJA.nc').UGRD_GDS0_ISBL_S123[:63,::-1,:,:]
ERA5_annual = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/ERA5/ua/ERA5_u_1958-2020_288x145_19levels_zonmean.nc').u[:,::-1,:,:]
JRA55_annual = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/JRA-55/ua/JRA55_u_1958-2022_288x145_19levels_zonmean.nc').UGRD_GDS0_ISBL_S123[:63,::-1,:,:]
#MERRA2_DJF = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/MERRA-2/ua/u_MERRA2_1980-2021_zonmean_288x145_19levels_DJF.nc').U[:-2]
#MERRA2_JJA = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/MERRA-2/ua/u_MERRA2_1980-2021_zonmean_288x145_19levels_JJA.nc').U[:-2]
#MERRA2_annual = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/obs-data/MERRA-2/ua/u_MERRA2_1980-2022_zonmean_288x145_19levels_yearmean.nc').U[:-2]
...
obs_JJA=[ERA5_JJA[:,upperlevel]-ERA5_JJA[:,lowerlevel],JRA55_JJA[:,upperlevel]-JRA55_JJA[:,lowerlevel]]#,MERRA2_DJF[:,upperlevel]-MERRA2_DJF[:,lowerlevel]]
obs_annual=[ERA5_annual[:,upperlevel]-ERA5_annual[:,lowerlevel],JRA55_annual[:,upperlevel]-JRA55_annual[:,lowerlevel]]#,MERRA2_DJF[:,upperlevel]-MERRA2_DJF[:,lowerlevel]]
...
obs_DJF_trendN=np.zeros(2)
obs_JJA_trendN=np.zeros(2)
obs_annual_trendN=np.zeros(2)
obs_DJF_trendS=np.zeros(2)
obs_JJA_trendS=np.zeros(2)
obs_annual_trendS=np.zeros(2)
...
for i in range(2):
    ...
    obs_DJF_trendN[i], _ = dyl.get_slope_p_2D(obs_DJF_areameanN,np.arange(63))
    obs_DJF_trendS[i], _ = dyl.get_slope_p_2D(obs_DJF_areameanS,np.arange(63))
    obs_JJA_trendN[i], _ = dyl.get_slope_p_2D(obs_JJA_areameanN,np.arange(63))
    obs_JJA_trendS[i], _ = dyl.get_slope_p_2D(obs_JJA_areameanS,np.arange(63))
    obs_annual_trendN[i], _ = dyl.get_slope_p_2D(obs_annual_areameanN,np.arange(63))
    obs_annual_trendS[i], _ = dyl.get_slope_p_2D(obs_annual_areameanS,np.arange(63))
...
hist_GHG_DJF = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/hist-GHG/ua_hist-GHG_all_models_1958-2019_288x145_zonmeanDJF.nc').ua[:,:]
hist_GHG_JJA = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/hist-GHG/ua_hist-GHG_all_models_1958-2019_288x145_zonmeanJJA.nc').ua[:,:]
hist_GHG_annual = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/hist-GHG/ua_hist-GHG_all_models_1958-2019_288x145_zonmean.nc').ua[:,:]
hist_aer_DJF = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/hist-aer/ua_hist-aer_all_models_1958-2019_288x145_zonmeanDJF.nc').ua[:,:]
hist_aer_JJA = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/hist-aer/ua_hist-aer_all_models_1958-2019_288x145_zonmeanJJA.nc').ua[:,:]
hist_aer_annual = xr.open_dataset(r'/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/hist-aer/ua_hist-aer_all_models_1958-2019_288x145_zonmean.nc').ua[:,:]
hist_all_forcing_DJF = xr.open_dataset(r'/home/dongyl/Databank/h+ssp585/zonmean/ua_h+ssp585_all_models_1958-2022_zonmean_DJF.nc').ua[:,:63]
hist_all_forcing_JJA = xr.open_dataset(r'/home/dongyl/Databank/h+ssp585/zonmean/ua_h+ssp585_all_models_1958-2022_zonmean_JJA.nc').ua[:,:63]
hist_all_forcing_annual = xr.open_dataset(r'/home/dongyl/Databank/h+ssp585/zonmean/ua_h+ssp585_all_models_1958-2022_zonmean.nc').ua[:,:63]
...
for i in range(3):
    ...
    DJF_mme_trend_100minus200[i+2][0], DJF_mme_p_values_100minus200[i][0] = dyl.calculate_trend_2D_zonmean(DJF_mean_areamean_100minus200_N)
    DJF_mme_trend_100minus200[i+2][1], DJF_mme_p_values_100minus200[i][1] = dyl.calculate_trend_2D_zonmean(DJF_mean_areamean_100minus200_S)
    JJA_mme_trend_100minus200[i+2][0], JJA_mme_p_values_100minus200[i][0] = dyl.calculate_trend_2D_zonmean(JJA_mean_areamean_100minus200_N)
    JJA_mme_trend_100minus200[i+2][1], JJA_mme_p_values_100minus200[i][1] = dyl.calculate_trend_2D_zonmean(JJA_mean_areamean_100minus200_S)
    annual_mme_trend_100minus200[i+2][0], annual_mme_p_values_100minus200[i][0] = dyl.calculate_trend_2D_zonmean(annual_mean_areamean_100minus200_N)
    annual_mme_trend_100minus200[i+2][1], annual_mme_p_values_100minus200[i][1] = dyl.calculate_trend_2D_zonmean(annual_mean_areamean_100minus200_S)
...
for i in range(3):
    ...
    DJF_trend_100minus200_std[i+2][0], _ = np.std(dyl.calculate_trend_2D_sc(DJF_areamean_100minus200_N),axis=1)
    DJF_trend_100minus200_std[i+2][1], _ = np.std(dyl.calculate_trend_2D_sc(DJF_areamean_100minus200_S),axis=1)
    JJA_trend_100minus200_std[i+2][0], _ = np.std(dyl.calculate_trend_2D_sc(JJA_areamean_100minus200_N),axis=1)
    JJA_trend_100minus200_std[i+2][1], _ = np.std(dyl.calculate_trend_2D_sc(JJA_areamean_100minus200_S),axis=1)
    annual_trend_100minus200_std[i+2][0], _ = np.std(dyl.calculate_trend_2D_sc(annual_areamean_100minus200_N),axis=1)
    annual_trend_100minus200_std[i+2][1], _ = np.std(dyl.calculate_trend_2D_sc(annual_areamean_100minus200_S),axis=1)
...
for i in range(len(filepath_T)):
    if i == 1:
        T_245 = xr.open_dataset(filepath_T[i]).ta[:,:63, :, :, 0]
        ua_245 = xr.open_dataset(filepath_u[i]).ua[:, :63, :, :, 0]
    else:
        T_245 = xr.open_dataset(filepath_T[i]).ta[:,:63, :, :, 0]
        ua_245 = xr.open_dataset(filepath_u[i]).ua[:,:63, :, :, 0]
    years_hist = np.arange(1958, 2021)
    ...
    if i==0:
        annual_mme_trend_100minus200[1, 0] = delta_VST_u_100_200_mme245_N
        annual_mme_trend_100minus200[1, 1] = delta_VST_u_100_200_mme245_S
        annual_trend_100minus200_std[1, 0] = np.std(delta_VST_u_100_200_245_N, axis=0)
        annual_trend_100minus200_std[1, 1] = np.std(delta_VST_u_100_200_245_S, axis=0)
    if i == 1:
        DJF_mme_trend_100minus200[1, 0] = delta_VST_u_100_200_mme245_N
        DJF_mme_trend_100minus200[1, 1] = delta_VST_u_100_200_mme245_S
        DJF_trend_100minus200_std[1, 0] = np.std(delta_VST_u_100_200_245_N, axis=0)
        DJF_trend_100minus200_std[1, 1] = np.std(delta_VST_u_100_200_245_S, axis=0)
    if i==2:
        JJA_mme_trend_100minus200[1, 0] = delta_VST_u_100_200_mme245_N
        JJA_mme_trend_100minus200[1, 1] = delta_VST_u_100_200_mme245_S
        JJA_trend_100minus200_std[1, 0] = np.std(delta_VST_u_100_200_245_N, axis=0)
        JJA_trend_100minus200_std[1, 1] = np.std(delta_VST_u_100_200_245_S, axis=0)
...
sub_add_axes = [[0.05, 0.5, 0.18, 0.4], [0.28, 0.5, 0.18, 0.4],[0.5, 0.5, 0.18, 0.4],[0.72, 0.5, 0.18, 0.4],
                [0.11, 0.08, 0.32, 0.27],[0.56, 0.08, 0.32, 0.27]]
exp = ['OBS(1958-2020)','HIST+SSP585(1958-2020)','GHG(1958-2020)','AER(1958-2020)']
...
for i in range(6):
    ...
    ################################绘制不同外强迫作用的bar图########################################################
        ...
        i=i-4
        bar_DJF = ax3.bar(np.arange(1,25,5), DJF_mme_trend_100minus200[:,i] * 10, width=1,color='#ff5959', edgecolor='k',linewidth=.5, alpha=.8,
                      yerr=[s.flatten()[0] for s in DJF_trend_100minus200_std[:,i] * 10], capsize=2,
                      error_kw={'elinewidth': .4, 'capthick': .5})
        bar_JJA = ax3.bar(np.arange(2, 26, 5), JJA_mme_trend_100minus200[:,i] * 10, width=1,color='#facf5a', edgecolor='k',linewidth=.5,alpha=.8,
                          yerr=[s.flatten()[0] for s in JJA_trend_100minus200_std[:,i] * 10], capsize=2,
                          error_kw={'elinewidth': .4, 'capthick': .5})
        bar_annual = ax3.bar(np.arange(3, 27, 5), annual_mme_trend_100minus200[:,i] * 10, width=1,color='#3d6cb9', edgecolor='k',linewidth=.5,alpha=.8,
                          yerr=[s.flatten()[0] for s in annual_trend_100minus200_std[:,i] * 10], capsize=2,
                          error_kw={'elinewidth': .4, 'capthick': .5})

        ax3.set_title(labels[i], loc='right', fontsize=7)
        ax3.set_title('Δu$_{150}$-Δu$_{250}$', loc='left', fontsize=7)
        ...
        ax3.tick_params(axis='x', colors='k', direction='in', length=2, width=.5,
                        labelsize=7, labelcolor='k')
        ax3.xaxis.set_ticks(np.arange(2, 26, 5), ['OBS','VST(HIST\n+SSP585)', 'HIST+\nSSP585','GHG', 'AER'])
        ax3.set_ylim(-0.2, 0.6)
        #ax21.set_ylim(9, 31)
        ax3.axhline(y=0, xmin=0, xmax=13, color='k', linewidth=.7)
        ax3.axvline(x=4.5, ymin=-.5, ymax=1, color='grey', linewidth=.7,linestyle='--')
...
plt.savefig('/home/dongyl/UPWARD_SHIFT_OF_JET_STREAM_DATAFILES/figures/obs_all_GHGaer_meri_and_bar_1958-2020_100minus200.png',dpi=600)
