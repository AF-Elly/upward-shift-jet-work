...
for model in models:
    ...
    DEF = np.load(f'/home/dongyl/Work2024/Tl/obs_npy/DEF_historical_{model}_2060-2090_N_new.npy')
    print('ok')
    # 并行计算湍流指数和概率
    TI1, turbulence_probability_array = parallel_turbulence_analysis(VWS, DEF, lat)
    # 保存湍流指数和概率结果
    np.save(f'/home/dongyl/Work2024/Tl/obs_npy/TI1_historical_{model}_1980-2010_N_new.npy', TI1)
    np.save(f'/home/dongyl/Work2024/Tl/obs_npy/TI1_historical_{model}_1980-2010_N_frequency_500-10hpa_new.npy',
