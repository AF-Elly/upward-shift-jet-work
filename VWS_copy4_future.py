...
# 示例数据
models = ["MPI-ESM1-2-HR","MPI-ESM1-2-LR","NorESM2-MM", "MIROC6", "NorESM2-LM"]
#models = ["MPI-ESM1-2-HR"]#MPI-ESM1-2-HR运行中
for model in models:
    file_path1 = f'/home/dongyl/Work2024/Tl/deal_Tl_data/ua_interpolated/ua_ssp585_{model}_day_interpolated_289x145_N.nc'
    file_path2 = f'/home/dongyl/Work2024/Tl/deal_Tl_data/va_interpolated/va_ssp585_{model}_day_interpolated_289x145_N.nc'
    file_path3 = f'/home/dongyl/Work2024/Tl/deal_Tl_data/zg_interpolated/zg_ssp585_{model}_day_interpolated_289x145_N.nc'
    ...
    np.save(f'/home/dongyl/Work2024/Tl/obs_npy/VWS_ssp585_{model}_2060-2090_N.npy', VWS)
