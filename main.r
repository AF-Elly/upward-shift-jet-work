...
u=redop(8,1,6)
Zr=redECOF(Z,u,8,1,timefirst=T)  ##两个1含义不同 #nt=8:time, ns=1:number of spaces
...
o1.tls<-tls.A03(Zr@Y,Zr@X,Zr@noise1,Zr@noise2,nsig=158)
par(mfrow=c(1,2))
plotbetas(o1.tls)
plotrstat(o1.tls)
readline("Press <return to continue")

o1.rof<-tls.ROF(Zr@Y,Zr@X,Zr@noise1,Zr@noise2,nsig=158)
...
o2.tls<-tls.A03(Z2@Y,Z2@X,Z2@noise1,Z2@noise2,nsig=158)
o2.rof<-tls.ROF(Z2@Y,Z2@X,Z2@noise1,Z2@noise2,nsig=158)
...
o3.tls<-tls.A03(Z3@Y,Z3@X,Z3@noise1,Z3@noise2,nsig=158)
o3.rof<-tls.ROF(Z3@Y,Z3@X,Z3@noise1,Z3@noise2,nsig=158)
...
plotbetas(o6.ols)
plotrstat(o6.ols)
o6.tls<-tls.A03(Z6@Y,Z6@X,Z6@noise1,Z6@noise2,nsig=158)
o6.rof<-tls.ROF(Z6@Y,Z6@X,Z6@noise1,Z6@noise2,nsig=158)
